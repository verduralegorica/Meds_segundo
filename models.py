...
class Player(BasePlayer):
    ...
    p32 = models.FloatField(label='¿Cuánto pagarías por cada pastilla del medicamento escogido? (solo una toma, es decir, una pastilla/cápsula). Si has marcado "Ninguna" en la pregunta anterior, coloca 0', min=0, max=50)
    ...
    p42 = models.FloatField(label='¿Cuánto pagarías por cada pastilla del medicamento escogido? (solo una toma, es decir, una pastilla/cápsula). Si has marcado "Ninguna" en la pregunta anterior, coloca 0', min=0, max=50)
